...
public class TNTSheep extends EntitySheep implements ITNTSheep {
	...
	public TNTSheep(Location location, Player target) {
		...
		this.goalSelector.a(0, new PathfinderGoalBedwarsPlayer(this, 1D, false)); // Add
																					// bedwars
																					// player
																					// goal
		try {
			this.setGoalTarget((EntityLiving) (((CraftPlayer) target).getHandle()), TargetReason.TARGET_ATTACKED_ENTITY,
					false);
		} catch (Exception ex) {
			// newer spigot builds
