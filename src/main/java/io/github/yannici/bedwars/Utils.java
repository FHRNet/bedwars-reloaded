...
public final class Utils {
	...
	public static boolean isColorable(ItemStack itemstack) {
		if (itemstack.getType().equals(Material.STAINED_CLAY) || itemstack.getType().equals(Material.WOOL)
				|| itemstack.getType().equals(Material.CARPET) || itemstack.getType().equals(Material.STAINED_GLASS)
